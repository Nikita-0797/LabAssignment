package com.nik.exercise3;

import java.util.List;

import com.nik.exercise3.entity.Employee;
import com.nik.exercise3.entity.SBU;
...
public class Main {
	...
	public static void main(String[] args) {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("exercise_3.xml");
